...
`python manage.py migrate postings zero`
...
<nav class="mb-3 navbar sticky-top navbar-expand-lg navbar-light bg-light px-5">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
        <ul class="navbar-nav">
            {% if user.is_authenticated %}
            <li class="nav-item">
                <a class="nav-link" href="{% url 'postings:create_posting' %}">New</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">MyPage</a>
            </li>
...
{% for posting in postings %}
<a href="{% url 'postings:posting_detail' posting.id %}">
    {% include 'postings/_posting.html' %}
</a>
{% endfor %}
</div>
...
```html
<nav class="mb-3 navbar sticky-top navbar-expand-lg navbar-light bg-light px-5">
    <a class="navbar-brand" href="{% url 'postings:posting_list' %}">
        <i class="fab fa-instagram"></i> | Instagram
    </a>
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent"
        aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
...
postings - views.py - update_posting 함수
...
{% block body %}
{% include 'postings/_posting.html' %}
{% include 'postings/_comment.html' %}
{% endblock body %}
```

`touch postings/templates/postings/_comment.html`
...
<div class="card-body">
    ...
    <p class="card-text"><strong>{{comment.author}}</strong> {{comment.content}}</p>
    {% empty %}
	...
	<div class="card-body">
		<form action="{% url 'postings:like' posting.id %}" method="POST">
			...
			<button style="border: 0; background: none;">
				{% if is_like %}
				<i class="fas fa-heart fa-lg" style="color: #ed4956;">
				</i>
				{% else %}
